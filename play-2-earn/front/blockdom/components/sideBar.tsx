          ...
          <motion.a
            ...
            className={` group px-3 py-3 rounded-full transition-all ease-linear text-center cursor-pointer ${
              activeSection === link.name
                ? "w-36 my-[3rem]  bg-gradient-to-r  -rotate-90 from-[#63AE94]/50 to-[#8EE5C4]/50  dark:from-gray-900/80 dark:to-[#5ECFA4]/40  dark:hover:from-gray-800/80 dark:hover:to-[#5ECFA4]/50 "
                : " bg-gray-400/70 dark:bg-gray-800/70 hover:bg-gray-700/70"
            }`}
            onClick={() => {
