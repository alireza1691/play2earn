    ...
    <section className="flex flex-wrap sm:p-0 h-auto">
      <div className="w-full lg:w-[50%]  flex flex-col items-center  ">
        ...
        >
          ...
          >
            <h1 className=" text:[72px] text-gray-800 dark:text-gray-200 sm:text-[48px] text-center sm:text-left font-bold">
              Lorem ipsum dolor sit amet
            </h1>
            <p className=" text-center text-[16px] text-gray-600 dark:text-gray-400  font-medium sm:text-left pt-4">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Pariatur
              hic saepe eaque asperiores, maxime quaerat ad harum eveniet?
              Praesentium dolores autem soluta illum, iure assumenda saepe
              consectetur. Eveniet, repellendus ut.
            </p>
          </motion.div>
      ...
      <div className="w-full mt-[10rem] lg:mt-0 sm:pr-[7%] lg:w-[50%] pt-[4rem] sm:pt-0 flex flex-col items-center gap-5 z-10  opacity-50 ">
        <div className="flex  w-full  gap-5 mr-auto  justify-center lg:justify-start">
          <div className="  h-full flex flex-col gap-3 justify-around ">
            <div className=" bg-white/50  rounded-2xl overflow-hidden">
              <Image
                className=" object-fill w-[318px] h-[242px]"
                src={"/test.jpeg"}
                width={318}
                height={242}
                alt={"test"}
          ...
          <div className=" bg-white/40 rounded-2xl overflow-hidden">
            <Image
              className=" object-fill h-[466px] w-[299px] "
              src={"/test.jpeg"}
              width={299}
              height={466}
              alt={"test"}
