...
export default function Roadmap() {
  ...
  return (
    <section ref={ref} id="roadmap" className="relative mb-[22.5rem]">
      <div className="h-[50rem] w-1 md:h-1 left-[50%] md:left-0 md:w-full  absolute mt-[10rem] md:mt-[25rem] bg-gradient-to-t md:bg-gradient-to-r from-white dark:from-black via-blue-gray-400/60 dark:via-gray-200 "></div>
      ...
      <div className="  relative flex flex-col md:flex-row  justify-around px-[10rem]  pt-[8rem] md:pt-0 mt-[10rem] md:h-[initial] md:mt-[15rem] ">
        {roadmapSteps.map((step, index) => (
          <React.Fragment>
            <div className=" group relative">
              ...
              <div className="group-even:mt-[12.5rem] h-40 w-40  relative">
