...
export default function Questions() {
  ...
  return (
    ...
    >
      ...
      <Image className=" right-[1.75rem] xl:right-[10rem] lg:right-[6rem] 2xl:right-[15%] lg:-bottom-[5rem] -z-10 md:-bottom-[10rem]  md:right-[3.75rem] -bottom-[5rem] absolute " src={ theme == "dark" ?"/svg/unions/questionsRightUnion.svg": "/svg/unions/lightQuestionsRightUnion.svg"} width={240} height={240} alt={"leftUnion"}></Image>
