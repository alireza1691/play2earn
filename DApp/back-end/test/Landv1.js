...
//       await wood.attachLandsAddress(lands.getAddress())
//       await iron.attachLandsAddress(lands.getAddress())
//       await gold.attachLandsAddress(lands.getAddress())
//       await food.attachLandsAddress(lands.getAddress())
//       console.log("Attached!");
//       const Building = await ethers.getContractFactory("BuildingV1");
