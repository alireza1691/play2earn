...
export default function Roadmap() {
  ...
  return (
    <section ref={ref} id="roadmap" className="relative mb-[22.5rem]">
      ...
      <div className="z-10 h-[66rem] w-1 lg:h-1 left-[50%] lg:left-0  lg:w-full  absolute mt-[25rem] lg:mt-[25rem] bg-gradient-to-t lg:bg-gradient-to-r from-black via-gray-200 "></div>
      ...
      <div className=" absolute mb-10 px-8  lg:px-[10rem]">
        <h3 className="mb-4 font-bold text-[28px] text-[#A5F4B6]">Roadmap</h3>
        <p>
          ...
          <React.Fragment key={key}>
            <div className=" group relative w-fit md:w-full text-center">
              ...
              <div className=" translate-y-[90%] lg:translate-y-0 group-odd:-left-[5.5rem] max-w-[120px]  md:max-w-[22.5rem] md: ml-auto md:mr-auto group-even:-right-[5.5rem] lg:group-odd:-left-0 lg:group-even:-right-0 lg:group-even:mt-[12.5rem] h-40 w-40 lg:w-[16rem] relative">
                <h3 className=" text-[16px] text-[#A5F4B6] text-center font-[700]">
                  {step.title}
                </h3>
                <p className="text-[12px] mt-2 text-[#BFBFBF] text-center font-[500] ">
                  {step.description} 
                </p>
                <p className="  text-center text-[12px]text-gray-100 mt-2 font-[700]">
                  {step.releaseTime}
                </p>
              </div>
            </div>
