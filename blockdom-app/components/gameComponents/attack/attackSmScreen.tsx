...
export default function AttackSmScreen() {
  ...
  return (
    <div className="flex sm:hidden flex-col  w-full h-full border-[#D4D4D4]/30 bg-[#0D0F12]/85  backdrop-blur-md  rounded-[4px] border">

    <div className=' justify-between bg-[#0D0F12]/85 flex flex-row p-1 rounded-t-lg items-center'> <h2 className='p-1 blueText !font-normal !text-[16px]'>Attack</h2> <button className='p-1 rounded-[4px] hover:bg-white/10 active:bg-[color:var(--pw-accent)]/30'><CloseIcon/></button></div>
