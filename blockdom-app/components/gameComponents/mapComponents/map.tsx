      ...
      {selectedParcel == null && (
        <>
          {/* <div className=" grid grid-cols-3 z-10  xl:h-[160rem] xl:w-[157rem]  bg-[url(/map/Base.png)] bg-cover ">
            ...
            <div className='flex  z-10 w-[98rem] h-[110rem]   xl:h-[160rem] xl:w-[145rem]  bg-[url(/map/Base.png)] bg-cover overflow-hidden blur-sm '>
        <div className=' absolute right-0 top-0 flex flex-col ml-auto -mt-[11.5rem] xl:-mt-[22.5rem]  w-auto'>
        <Image className=' translate-x-2/3 blur-sm h-[27.25rem] xl:h-[41.5rem] w-auto' quality={10} src={"/map/Outer5.png"} width={100} height={100} alt='map'/>
        <Image className=' translate-x-2/3 blur-sm h-[27.25rem] xl:h-[41.5rem] w-auto' quality={10} src={"/map/Outer6.png"} width={100} height={100} alt='map'/>
        <Image className=' translate-x-2/3 blur-sm h-[27.25rem] xl:h-[41.5rem] w-auto' quality={10} src={"/map/Outer6.png"} width={100} height={100} alt='map'/>
        <Image className=' translate-x-2/3 blur-sm h-[27.25rem] xl:h-[41.5rem] w-auto' quality={10} src={"/map/Outer6.png"} width={100} height={100} alt='map'/>
