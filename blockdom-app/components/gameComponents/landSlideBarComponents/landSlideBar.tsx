      ...
      <div
        className={`${
          selectedLand
            ...
            : "!-left-[50rem]"
        }  ${selectedWindowComponent == "attack" && "hidden"} flex flex-col transition-all  top-[4.55rem] absolute h-[85%] w-[90%] md:w-[22.5rem]  px-3 bg-[#21302A]/60 backdrop-blur-sm rounded-2xl `}
      >
        <LandSlideBarHeader/>
        <LandSlideBarCard/>
<LandSlidebarContent/>
