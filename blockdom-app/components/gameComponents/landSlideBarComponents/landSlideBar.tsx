      ...
      <div
        className={`${
          selectedLand
            ...
            : "!-left-[120rem]"
        }  ${selectedWindowComponent == "attack" && "hidden"} flex flex-col transition-all top-[4.5rem]  md:top-[8rem] absolute h-[75dvh] lg:h-[80dvh]  w-[90%] md:w-[22.5rem]  px-3 bg-[#0D0F12]/85 backdrop-blur-sm rounded-[4px] `}
      >
        <LandSlideBarHeader/>
        <LandSlideBarCard/>
<LandSlidebarContent/>
