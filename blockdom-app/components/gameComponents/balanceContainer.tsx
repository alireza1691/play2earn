        ...
        <>
          ...
          >
            <button
              ...
              } backdrop-blur-sm cursor-pointer transition-all hover:bg-white/10 text-[#87F0E5] font-semibold text-[15px]  balBg flex flex-row gap-4 items-center justify-center px-4 py-1`}
            >
              <BMTIcon />
