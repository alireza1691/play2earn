...
export default function Dashboard() {
  ...
  return (
    <main className=" overflow-hidden w-screen h-screen relative">
      <section className="flex gap-10 flex-col md:flex-row absolute z-10 h-[70dvh] lg:h-[80dvh] w-[90%]  battleLogWindowBg -translate-x-1/2 left-1/2 top-[8rem] rounded-[4px] p-10">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full px-3 py-2  rounded-[4px] focus:outline-none text-white/70 text-sm"
            required
          />
        </div>
        <div className="mb-4">
