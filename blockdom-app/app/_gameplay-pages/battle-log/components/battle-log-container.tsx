...
import BattleLogTabs from "./battle-log-tabs";
...
export default function BattleLogContainer() {
  ...
  return (
    <>
      ...
      <section className="flex absolute z-10 h-[70dvh] lg:h-[80dvh] w-[90%]  battleLogWindowBg -translate-x-1/2 left-1/2 top-[8rem] rounded-[4px] ">
