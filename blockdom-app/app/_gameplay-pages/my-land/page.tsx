      ...
      <div className=" w-screen h-screen overflow-hidden relative">
        <div className=" w-[100dvw] h-[100dvh]   overflow-scroll custom-scrollbar  items-center justify-center  relative ">
          <div className=" 2xl:h-[138rem] absolute w-[1920px] h-[110rem]   xl:h-[138rem] xl:w-[2560px]  ">
            ...
            <div className="flex z-30 h-screen w-screen bg-black/50 backdrop-blur-lg fixed">
              {" "}
              <h3 className=" mt-auto mb-auto ml-auto mr-auto max-w-[15.5rem] sm:max-w-[22.5rem] text-center">
                {" "}
                The Mainnet town will become available when the user count
                reaches a minimum of 500.
              </h3>
            </div>
            <Town />
          </div>
